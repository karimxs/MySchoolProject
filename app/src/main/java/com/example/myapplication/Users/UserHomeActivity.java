    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.user_bottom_nav_home) {
                    selectedFragment = new UserHomeFragment();
                } else if (menuItem.getItemId() == R.id.user_bottom_nav_saved) {
                    selectedFragment = new UserSavedFragment();
                } else if (menuItem.getItemId() == R.id.user_bottom_nav_bookings) {
                ...
                if (selectedFragment != null) {
                    getSupportFragmentManager()
                            .beginTransaction()
                            .replace(R.id.user_fragment_container, selectedFragment)
                            .commit();
                }
