...
import com.example.myapplication.Model.AgentRoom;
import com.example.myapplication.Model.UserRoom;
import com.example.myapplication.R;
import com.example.myapplication.ViewHolders.AgentRoomsViewHolder;
import com.example.myapplication.ViewHolders.UserRoomViewHolder;
...
public class UserAllRoomsActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<UserRoom, UserRoomViewHolder> adapter=new FirebaseRecyclerAdapter<UserRoom, UserRoomViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull UserRoomViewHolder userRoomViewHolder, @SuppressLint("RecyclerView") final int i, @NonNull UserRoom userRoom) {
