...
import com.example.myapplication.Model.AdminManageUsers;
import com.example.myapplication.R;
import com.example.myapplication.ViewHolders.AdminManageUsersViewHolder;
import com.example.myapplication.ViewHolders.AgentBookingsViewHolder;
...
public class AdminMagnageUsersFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<AdminManageUsers,AdminManageUsersViewHolder> adapter=new FirebaseRecyclerAdapter<AdminManageUsers, AdminManageUsersViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull AdminManageUsersViewHolder adminManageUsersViewHolder, @SuppressLint("RecyclerView") final int i, @NonNull final AdminManageUsers adminManageUsers) {
