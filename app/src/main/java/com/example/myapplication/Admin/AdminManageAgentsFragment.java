...
import com.example.myapplication.Model.AdminManageAgents;
import com.example.myapplication.R;
import com.example.myapplication.ViewHolders.AdminManageAgentViewHolder;
...
public class AdminManageAgentsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<AdminManageAgents, AdminManageAgentViewHolder> adapter=new FirebaseRecyclerAdapter<AdminManageAgents, AdminManageAgentViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull AdminManageAgentViewHolder adminManageAgentViewHolder, @SuppressLint("RecyclerView") final int i, @NonNull final AdminManageAgents adminManageAgents) {
